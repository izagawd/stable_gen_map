...
This Rust library provides a structure, `StableGenMap`, which provides a safe way to insert elements with a `&` reference, rather than a `&mut` reference, in a single threaded environment, which 
